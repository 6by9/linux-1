...
/*
 * FIXME: This is to remove the dependency on vc-mem which
 * exports mm_vc_mem_phys_addr, mm_vc_mem_size, and mm_vc_mem_base.
 * We only need mm_vc_mem_phys_addr here, and that appears to always
 * be set to 0.
 * This replaces a #include 
 */
static unsigned long mm_vc_mem_phys_addr = 0;
